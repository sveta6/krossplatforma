...
public class Main {
    ...
    public  static  void main(String[] args) throws InterruptedException {
       ...
       //part 1
        ...
        Thread t1 = new Thread(String.valueOf(sb));
        Thread t2 = new Thread(String.valueOf(sb));
        Thread t3 = new Thread(String.valueOf(sb));
        t1.start();
        t2.start();
        t3.start();
       ...
       windows.add(new Window(1, Window.ServiceCategory.ALL));
        ...
        System.out.println("Count of leaving: "+ "\t Young: "+YoungLeave+ "\t Old: "+ OldLeave+ "\t Business: "+ BusinessLeave);
